...
const ProcessService = ({ data, callApi, nullStateOverView }) => {
    ...
    return (
        <>
            ...
            <div>
                <h1 style={{ textAlign: "center" }}>Process Service</h1>
                                    ...
                                    isLoading ? (
                                        ...
                                        service.map((service, index) => (
                                            <tr key={index}>
                                                ...
                                                <td>{service.sub_title3}</td>
                                                <td>{service.sub_description3}</td>
                                                <td>{service.sub_title4}</td>
                                                <td>{service.sub_description4}</td> */}
