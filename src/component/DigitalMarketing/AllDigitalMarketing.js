...
const AllDigitalMarketing = () => {
  ...
  const getAllServices = useCallback(() => {
    ...
    const config = {
      url: `${ApiUrl.getAllServices}?category=digital_marketing${queryString}`,
      method: "GET",
    };
  ...
  return (
    <>
      <TitleChanger title="All Digital Marketing" />
      <BreadCrumb pageTitle="All Digital Marketing" />
...
export default AllDigitalMarketing;
