...
const AddDigigtalMarketing = () => {
  ...
  return (
    <>
      <TitleChanger title="Add Digital Marketing" />
      <BreadCrumb pageTitle="Add Digital Marketing" />
      <div>
              ...
              <div className="basic_info_con1">
                ...
                <div className="name">
                  ...
                  > // Update the state on selection change
                    <option value="digital_marketing" disabled>
                      Select Category
                    </option>
...
export default AddDigigtalMarketing;
