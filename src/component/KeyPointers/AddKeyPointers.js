...
const AddKeyPointers = () => {
  ...
  return (
    <>
      <TitleChanger title="Add Key Pointers" />
      <BreadCrumb pageTitle="Add KeyPointers" />
      <div>
              ...
              <div className="basic_info_con1">
                ...
                <div className="name">
                  ...
                  > // Update the state on selection change
                    <option value="key_pointers" disabled>
                      Select Category
                    </option>
