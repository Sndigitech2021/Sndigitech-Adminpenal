...
const AddIndustryDetails = () => {
  ...
  return (
    <>
      <TitleChanger title="Add Industry Details" />
      <BreadCrumb pageTitle="Add Industry Details" />
      <div>
              ...
              <div className="basic_info_con1">
                ...
                <div className="name">
                  ...
                  <select
                    ...
                    onChange={handleInputChange} // Update the state on selection change
                  >
                    <option value="industry_details" disabled>
                      Select Category
                    </option>
...
export default AddIndustryDetails;
