...
const All360MarketingServices = () => {
  ...
  const getAllServices = () => {
    ...
    const config = {
      url: `${ApiUrl.getAllServices}?category=360_marketing${queryString}`,
      method: "GET",
    };
  ...
  return (
    <>
      <TitleChanger title="All 360 Marketing Services" />
      <BreadCrumb pageTitle="All 360 Marketing Services" />
...
export default All360MarketingServices;
