...
const Add360MarketingServices = () => {
  ...
  return (
    <>
      <TitleChanger title="Add 360 Marketing Services" />
      <BreadCrumb pageTitle="Add 360 Marketing Services" />
      <div>
              ...
              <div className="basic_info_con1">
                ...
                <div className="name">
                  ...
                  > // Update the state on selection change
                    <option value="360_marketing" disabled>
                      Select Category
                    </option>
...
export default Add360MarketingServices;
