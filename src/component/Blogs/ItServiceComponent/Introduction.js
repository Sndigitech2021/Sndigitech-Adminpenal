...
const Introduction = ({ data, callApi, nullStateOverView }) => {
                                    ...
                                    isLoading ? (
                                        ...
                                        service.map((service, index) => (
                                            <tr key={index}>
                                                ...
                                                <td><DescriptionCell description={service.sub_title1} /></td>
                                                <td><DescriptionCell description={service.sub_description1} /></td>
                                                <td>{service.sub_title2}</td>
                                                <td><DescriptionCell description={service.sub_description2} /></td>
                                                <td>{service.type}</td>
                                                <td>
                                                    <img
