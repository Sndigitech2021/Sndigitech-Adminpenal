...
const AddBlogDetails = () => {
    ...
    return (
        <>
            <TitleChanger title="Add Blog Details" />
            <BreadCrumb pageTitle="Add Blog Details" />
            <div>
                            ...
                            <div className="basic_info_con1">
                                ...
                                <div className="name">
                                    ...
                                    >
                                        ...
                                        <option value="hero_section">hero_section</option>
                                        <option value="about_section">about_section</option>
