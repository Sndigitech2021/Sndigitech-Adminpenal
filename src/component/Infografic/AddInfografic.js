...
const AddInfografic = () => {
  ...
  const handlerAddSubCategory = (e) => {
    ...
    if (!data.industryCategoryId || !data.title || !data.description || !data.uploadedfile || !data.sub_title || !data.type) {
      toast.error("Please fill in all required fields.");
      return;
    }

    const formData = new FormData();
    formData.append('portfolioCategoryId', data.industryCategoryId);
  ...
  return (
    <>
      <TitleChanger title="Add Infographic List" />
      <BreadCrumb pageTitle="Add Infographic List" />
              ...
              <div className="basic_info_con1">
                ...
                <div className="name">
                  ...
                  > // Update the state on selection change
                    <option value="infographic_list" disabled>
                      Select Page Name
                    </option>
      ...
      >
        <Box sx={style}>
          ...
          >
            {/* Title Input */}
            <div className="name">
              <label>IndustryCategoryId</label>
              <input
                type="text"
                name="industryCategoryId"
                value={data.industryCategoryId}
                onChange={handleInputChange}
                placeholder="Enter industryCategoryId Here"
              />
            </div>
            <div className="name">
              <label>TITLE</label>
