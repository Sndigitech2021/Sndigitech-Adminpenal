...
const AllInfografic = () => {
  ...
  const getAllServices = useCallback(() => {
    ...
    const config = {
      url: `${ApiUrl.getAllCategory}?pageName=infographic_list`,
      method: "GET",
    };
    ...
    APIRequest(
      config,
      (res) => {
        console.log("industrylistdetails", res.data);
  ...
  const handleView = (service) => {
    ...
    navigate('/app/all-infographic-details', { state: { service } });
  ...
  // console.log("dataddddddddddddddddd", data);


  return (
    <>
      <TitleChanger title="All Infographic List" />
      <BreadCrumb pageTitle="All Infographic List" />
